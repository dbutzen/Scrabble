<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="TS.Scrabble.WFUI._Default" %>
  ...
  <div class="game">
    ...
    <div class="score-board">
        <table class="score-board">
            ...
            <tr><td>Peter</td> <td>1000</td></tr>
            <tr><td>Lois</td><td>900</td></tr>
        </table>
    </div>
